...
#define MIXER_BIAS_MIN           -2048
#define MIXER_BIAS_MAX           2047
#define MIXER_BIAS_ZERO          0
#define MIXER_BIAS_SWEEP_STEP    4
// magnet DAC range and sweep step size
#define MIXER_MAGNET_MIN         -2047
#define MIXER_MAGNET_MAX         2048
#define MIXER_MAGNET_ZERO        0
#define MIXER_MAGNET_SWEEP_STEP  4
